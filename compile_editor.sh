...
# Nova Engine Editor Build Script
echo "========================================"
...
SOURCE_DIR="$PROJECT_DIR/editor/src"
INCLUDE_DIR="$PROJECT_DIR/editor/include"
BIN_DIR="$PROJECT_DIR/editor/bin/Release"
OBJ_DIR="$PROJECT_DIR/editor/obj/Release"
...
echo "[STEP 1/3] Compiling editor source files..."

# Find all .cpp files in editor/src
...
echo "  Compiling: $PROJECT_DIR/editor/main.cpp"
g++ -c "$PROJECT_DIR/editor/main.cpp" -o "$OBJ_DIR/main.o" \
    -I"$SDK_DIR" \
    -I"$INCLUDE_DIR" \
    -DSFML_STATIC \
    -std=c++17 \
...
echo ""
echo "[STEP 2/3] Linking editor executable..."

g++ $OBJECT_FILES -o "$BIN_DIR/NovaEditor" \
    -L"$LIB_DIR" \
    -DSFML_STATIC \
    -lsfml-graphics-s \
    -lsfml-window-s \
...
echo ""
echo "Executable: $BIN_DIR/NovaEditor"
echo ""
echo "========================================"
...
echo "  cd $PROJECT_DIR"
echo "  ./editor/bin/Release/NovaEditor"
echo ""
